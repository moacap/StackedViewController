...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       * Don't worry about the indent, we strip it!
                       DESC
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/StackedViewController"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "ifapmzadu6" => "ifapmzadu6@gmail.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/StackedViewController.git", :tag => s.version.to_s }
